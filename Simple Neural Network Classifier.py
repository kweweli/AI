...
# The interesting class (i.e., the bacterium worth studying or 1) is very small as compared to the other class so it is 
# given a weight of 2. In other words, one data point from class 1 is worth twice from class 0. I tried different values 
# for epochs and 35 seems to be the best in tracking the validation loss (at least for the current model structure). 
# A natural extension might be to try different model structure.
