...
def nearest_neighbor(v, candidates, k=1):
    ...
    similarity_l = np.array(similarity_l)
...
def hash_value_of_vector(v, planes):
    ...
    h = np.array([1 if i >= 0 else 0 for i in sign_of_dot_product.flatten()])
...
print(f"The first 5 document indices stored at key 0 of are {tmp_id_table[0][0:3]}")
